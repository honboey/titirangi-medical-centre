    ...
    return (
        <Layout title=" | About">
            <div className="wrapper max-w-screen-xl mx-auto p-4 lg:p-8">
                <section className="mx-1/24 border-l border-r border-black px-1/24 py-8 mb-8 lg:flex">
                    <div className="lg:w-1/2 lg:pr-1/22 lg:border-r lg:border-black">
                        <h2 className="font-display text-4xl md:text-6xl leading-snug md:leading-normal mb-4">About our clinic</h2>
                    </div>
                    <div className="lg:w-1/2 lg:pl-1/22">
                ...
                <section className="mx-1/24 border-l border-black px-1/24 py-8 mb-24">
                    ...
                    <div className="lg:flex lg:justify-end">
                        <figure className="lg:w-18/22 mb-8">
                ...
                <section className="mx-1/24 border-l border-r border-black px-1/24 py-8 mb-24 lg:flex">
                    <div className="lg:w-1/2 lg:pr-1/22 lg:border-r lg:border-black">
